...
import type { CustomEmbedLinkMenuLabels } from './CustomEmbedLinkMenu'
...
const btnStyleMap = (btnColor?: ButtonColor) => {
  if (btnColor) {
    return colorMap[btnColor] ?? colorMap.gray
  }
...
export function DownloadActions({
  ...
  const { payload, isLoading, error } = useMagicLink(path)
