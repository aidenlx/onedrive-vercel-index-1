...
import { toCustomisedPermLink, toPermLink } from '@od/util/permlink'
...
function CopyButton({ value, disabled }: { value: string; disabled?: boolean }) {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className="dark:bg-gray-850 absolute top-[0.2rem] right-[0.2rem] w-8 rounded border border-gray-400/40 bg-gray-100 py-1.5 opacity-0 transition-all duration-100 hover:bg-gray-200 group-hover:opacity-100 dark:hover:bg-gray-700"
    >
